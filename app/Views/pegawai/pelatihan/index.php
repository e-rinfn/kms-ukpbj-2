...
<div class="container mt-3">
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <a href="/pegawai/pelatihan/create" style="background-color:#EC1928;" class="btn btn-danger rounded-pill fw-bold">
    ...
    <div class="card p-3 border rounded bg-light">
        <div class="card-body">
            ...
            <?php if (!empty($search) || isset($filterAkses)): ?>
                <div class="mb-3">
                    <a href="/pegawai/pelatihan" class="btn btn-sm btn-outline-secondary">
                    ...
                    <?php else: ?>
                        ...
                        ?> <?php foreach ($pelatihan as $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/pegawai/pelatihan/view/<?= $p['id']; ?>" class="btn btn-sm btn-info">Detail</a>
                                    <a href="/pegawai/pelatihan/edit/<?= $p['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="/pegawai/pelatihan/delete/<?= $p['id']; ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field(); ?>
