...
<div class="container mt-3">
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h2 class="mb-0">DAFTAR PENGETAHUAN</h2>
            <a href="/pegawai/pengetahuan/create" style="background-color: #EC1928;" class="btn btn-danger rounded-pill fw-bold">
    ...
    <div class="card p-3 border rounded bg-light">
        <div class="card-body">
            ...
            <?php if (!empty($search) || isset($filterAkses)): ?>
                <div class="mt-3">
                    <a href="/pegawai/pengetahuan" class="btn btn-sm btn-outline-secondary">
                        ...
                        <?php foreach ($pengetahuan as $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if (!empty($p['file_pdf_pengetahuan'])): ?>
                                        <a href="<?= base_url('/assets/uploads/pengetahuan/' . $p['file_pdf_pengetahuan']); ?>" target="_blank" style="background-color: #341EBB; border: none;" class="badge">Lihat File</a>
                                    <?php else: ?>
                                ...
                                <td class="text-center">
                                    <a href="/pegawai/pengetahuan/view/<?= $p['id']; ?>" class="btn btn-sm btn-info">Detail</a>
                                    <a href="/pegawai/pengetahuan/edit/<?= $p['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="/pegawai/pengetahuan/delete/<?= $p['id']; ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field(); ?>
