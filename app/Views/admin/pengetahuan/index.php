...
<div class="container mt-3">
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <a href="/admin/pengetahuan/create" style="background-color: #EC1928;" class="btn btn-danger rounded-pill fw-bold">
    ...
    <div class="card p-3 border rounded bg-light">
        <div class="card-body">
            ...
            <?php if (!empty($search) || isset($filterAkses)): ?>
                <div class="mt-3">
                    <a href="/admin/pengetahuan" class="btn btn-sm btn-outline-secondary">
                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($pengetahuan as $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/pengetahuan/view/<?= $p['id']; ?>" class="btn btn-sm btn-info">Detail</a>
                                    <a href="/admin/pengetahuan/edit/<?= $p['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="/admin/pengetahuan/delete/<?= $p['id']; ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field(); ?>
