...
<div class="container mt-3">
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <a href="/admin/template/create" style="background-color: #EC1928;" class="btn btn-danger rounded-pill fw-bold">
    ...
    <div class="card p-3 border rounded bg-light">
        <div class="card-body">
            ...
            <?php if (!empty($search) || isset($filterAkses)): ?>
                <div class="mt-3">
                    <a href="/admin/template" class="btn btn-sm btn-outline-secondary">
                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($template as $t): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <!-- <a href="/admin/template/view/<?= $t['id']; ?>" class="btn btn-sm btn-success">Detail</a> -->
                                    <?php if (!empty($t['file_docx'])): ?>
                                        <a href="<?= base_url('/assets/uploads/template/' . $t['file_docx']); ?>" class="btn btn-sm btn-success">Download</a>
                                    <?php else: ?>
                                        <span class="badge bg-secondary">Tidak ada file</span>
                                    <?php endif; ?>
                                    <a href="/admin/template/edit/<?= $t['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="/admin/template/delete/<?= $t['id']; ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field(); ?>
