                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($template as $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/template/view/<?= $p['id']; ?>" class="btn btn-sm btn-info">Detail</a>
                                    <a href="/admin/template/edit/<?= $p['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="/admin/template/delete/<?= $p['id']; ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field(); ?>
