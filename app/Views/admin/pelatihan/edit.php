...
<div class="container mt-3">
    ...
    <div class="card p-3 border rounded bg-light shadow-sm">
        <form action="/admin/pelatihan/update/<?= $pelatihan['id']; ?>" method="post" enctype="multipart/form-data" id="uploadForm">
            <?= csrf_field(); ?>
            ...
            <a href="/admin/pelatihan" class="btn btn-secondary">Batal</a>
                ...
                if (xhr.status === 200) {
                    try {
                        ...
                        if (response.status === 'success') {
                            ...
                            setTimeout(() => window.location.href = '/admin/pelatihan', 2000);
                        } else {
                            progressBar.classList.remove('progress-bar-animated', 'bg-primary');
