...
<div class="container-fliud p-0">
    ...
    <section class="py-5 section-with-bg min-vh-100">
        <div class="container card bg-transparent border-0 mb-4">
            ...
            <form method="GET" action="<?= base_url('pengetahuan'); ?>">
                <div class="row justify-content-center gx-2 gy-2 align-items-center">
                    <div class="col-auto">
                            ...
                            <div class="card h-100" style="min-width: 20rem; min-height: 650px;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <a href="pengetahuan/view/<?= $p['id']; ?>" class="btn btn-primary w-100">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="my-5 py-4 px-0" style="background-color: #EC1928;">
        <div class="container">
            <div class="row">
                <!-- Bagian Peta -->
