...
<div class="container-fliud p-0">
    ...
    $filtered_pengetahuan = array_filter($pengetahuan, function ($item) use ($q) {
        // Filter berdasarkan nama_pengunggah dan caption_pengetahuan
        return !$q ||
            strpos(strtolower($item['caption_pengetahuan']), $q) !== false;
    });
    ?>
    ...
    <section class="py-5 section-with-bg min-vh-100">
        <div class="container card bg-transparent border-0 mb-4">
            ...
            <div class="bg-light rounded p-3">
                <h2 class="mb-2 fw-bold text-center">Daftar Pengetahuan</h2>
                <p class="text-muted text-center mb-4">
                    Temukan berbagai pengetahuan yang telah dibagikan.
                </p>
            </div>
            <br>
            <!-- Form Search -->
            <form method="GET" action="<?= base_url('pengetahuan'); ?>">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10 col-sm-12">
                        <div class="input-group">
                            <a href="<?= base_url('pengetahuan'); ?>" class="btn btn-secondary">
                                <i class="bi bi-arrow-repeat"></i> Reset
                            </a>
                            <input type="text" name="q" class="form-control text-center"
                                placeholder="Cari pengetahuan..." value="<?= esc($keyword ?? '') ?>">
                            <button type="submit" style="background-color: #341EBB; border: none;" class="btn btn-primary">
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php foreach ($pengetahuan as $p): ?>
                    <?php if ($p['akses_publik']): // Tampilkan hanya jika akses_publik bernilai true 
                    ?>
                        <div class="col">
                            <div class="card h-100" style="min-width: 20rem; min-height: 650px;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <a href="pengetahuan/view/<?= $p['id']; ?>" style="background-color: #341EBB; border: none;" class="btn btn-primary rounded-pill w-100">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
