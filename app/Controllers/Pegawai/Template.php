...
class Template extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('pegawai/template/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('pegawai/template/create', $data);
    }
    ...
    public function save()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/pegawai/template/create')->withInput()->with('validation', $this->validator);
        }
        ...
        return redirect()->to('/pegawai/template');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pegawai/template/edit', [
            'template' => $data
        ]);
    }
    ...
    public function update($id)
    {
        ...
        if (!$this->validate($rules)) {
            return redirect()->to('/pegawai/template/edit/' . $id)->withInput();
        }
    ...
    public function view($id)
    {
        ...
        return view('pegawai/template/view', [
            'template'      => $template,
