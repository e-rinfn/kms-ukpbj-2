...
class Template extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('users/template/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('users/template/create', $data);
    }
    ...
    public function save()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/users/template/create')->withInput()->with('validation', $this->validator);
        }
        ...
        return redirect()->to('/users/template');
    }
    ...
    public function update($id)
    {
        ...
        if (!$this->validate($rules)) {
            return redirect()->to('/users/template/edit/' . $id)->withInput();
        }
    ...
    public function view($id)
    {
        ...
        return view('users/template/view', [
            'template'      => $template,
