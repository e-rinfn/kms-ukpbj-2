...
class Pengetahuan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('users/pengetahuan/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('users/pengetahuan/create', $data);
    }
    ...
    public function save()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/users/pengetahuan/create')->withInput()->with('validation', $this->validator);
        }
        ...
        return redirect()->to('/users/pengetahuan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('users/pengetahuan/edit', [
            'pengetahuan' => $data
        ]);
    }
    ...
    public function update($id)
    {
        ...
        if (!$this->validate($rules)) {
            return redirect()->to('/users/pengetahuan/edit/' . $id)->withInput();
        }
    ...
    public function view($id)
    {
        ...
        return view('users/pengetahuan/view', [
